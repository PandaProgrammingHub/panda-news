            ...
            <div className="navbarContainner" >
                ...
                <div className="w3-top">
                    <div className="w3-bar w3-theme-d2 w3-left-align w3-large">
                        ...
                        <a className="w3-bar-item w3-button w3-padding-large w3-theme-d4"><i className="fa fa-home w3-margin-right"></i>PANDA-NEWS</a>
                        <a className="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white" title="INDIA">INDIA</a>
                        <a className="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white" title="WORLD">WORLD</a>
                        <a className="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white" title="SPORTS">SPORTS</a>
                        <a className="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white" title="Messages">BUSINESS</a>
